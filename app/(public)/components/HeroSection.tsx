  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-neo neo-glass-brutal neo-shadow text-gray-900 text-sm mb-8 font-bold">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
            </span>
            <span>100+ Food Trucks Available</span>
          </div>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6">
            {[
              ...
              <div
                key={index}
                className="flex items-center gap-3 px-5 py-3 rounded-neo neo-glass-brutal neo-shadow text-gray-900 transition-all duration-300 hover:neo-shadow-lg hover:scale-105"
