    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="neo-glass-brutal-primary rounded-neo p-10 md:p-16 neo-shadow-primary-lg text-center">
          ...
          {/* Title */}
          <h2 className="neo-heading-xl text-gray-900 mb-6 leading-tight">
            {title}
          </h2>

          {/* Description */}
          <p className="text-lg md:text-xl text-gray-900 mb-10 max-w-2xl mx-auto leading-relaxed font-medium">
            {description}
          </p>
          ...
          {/* Trust Badges */}
          <div className="mt-12 flex flex-wrap justify-center items-center gap-6 text-gray-900 text-sm">
            ...
            <div className="w-px h-4 bg-gray-400 hidden sm:block" />
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
